...
| 04 | [Provider spike: validate the data source](v0.1/04-provider-spike.md) | IN PROGRESS (Claude) | — |
...
| 08 | [i18n (zh + en) — do early](v0.1/08-i18n.md) | BLOCKED | 01 |
| 09 | [CI: format + analyze + test — do early](v0.1/09-ci.md) | BLOCKED | 01 |
...
| 15 | [App icon](v0.1/15-app-icon.md) | BLOCKED | 01 |
