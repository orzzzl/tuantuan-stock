...
| 31 | [Provider spike v3c: Alpaca Basic overnight feed](v0.4/31-alpaca-overnight-spike.md) | IN REVIEW (Codex; live probe complete; owner data-source sign-off required) | Owner sign-off |

## Order of attack (v0.4)

- 29 and 30 are complete; task 30's no-product-GO is owner-signed. Task 31's live,
  report-only Alpaca Basic probe is complete and awaits review plus owner sign-off on
  its conditional research GO. Any source decision still requires owner sign-off
